...
<head>
    ...
    <title>System Software - Video Lectures</title>
...
<body>
    ...
    <div class="container">
        <h1 class="mb-4 text-center">System Software - Video Lectures</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6 video-card">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Introduction to System Software</h5>
                        <iframe id="video1" width="100%" height="315" 
                            src="https://www.youtube.com/embed/Ts8hvn198mM" 
            ...
            <div class="col-md-6 video-card">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Assemblers and Loaders</h5>
                        <iframe id="video2" width="100%" height="315" 
                            src="https://www.youtube.com/embed/cJDRShqtTbk" 
                            frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 video-card">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Compilers and Interpreters</h5>
                        <iframe id="video3" width="100%" height="315" 
                            src="https://www.youtube.com/embed/e4ax90XmUBc" 
                            frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 video-card">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">System Calls in OS</h5>
                        <iframe id="video4" width="100%" height="315" 
                            src="https://www.youtube.com/embed/iXV4d1Y3SW4" 
                            frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
